...
test_that("test_dynprog1: test basic operaton", {
  x <- matrix(c(1,1,5,1,1,0,5,0,1), nrow=3)
  testthat::expect_true(RcppDynProg:::test_solvers(x, 3))
  ...
  for(i in 1:10) {
    ...
    testthat::expect_true(RcppDynProg:::test_solvers(x3, 4))
  }
